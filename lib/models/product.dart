...
final List<Product> products = [
  Product(
      ...
      images: [
        'assets/cdn/02-16.jpg',
        'assets/cdn/01-17.jpg',
        'assets/cdn/03-16.jpg',
        'assets/cdn/06-13.jpg',
      ],
      price: 25,
      description:
  ...
  Product(
      ...
      category: Category.baby,
      images: [
        'assets/cdn/41N3dGH4PRL._AC_.jpg',
        'assets/cdn/513SEAiWTkL._AC_.jpg',
        'assets/cdn/51G-6CjEq4L._AC_.jpg',
      ],
      price: 14,
      description: '''
...
'''),
  Product(
    ...
    category: Category.baby,
    images: [
      'assets/cdn/41XTWZZ8E2L.jpg',
      'assets/cdn/41KB8FLwjlL.jpg',
      'assets/cdn/41t7RrDEsSL.jpg',
      'assets/cdn/4140C6Y71bL.jpg',
    ],
    price: 20,
    description: '''
...
''',
  ...
  Product(
      ...
      category: Category.baby,
      images: [
        'assets/cdn/01-20.jpg',
        'assets/cdn/03-20-600x600.jpg',
        'assets/cdn/02-20-600x600.jpg',
        'assets/cdn/04-20-600x600.jpg',
      ],
      price: 10,
      description: '''
...
'''),
  Product(
      ...
      category: Category.baby,
      images: [
        'assets/cdn/5135c4GbM9L.jpg',
        'assets/cdn/41zOB4qXXJL.jpg',
        'assets/cdn/41yE9T8T79L.jpg',
        'assets/cdn/31g1oh72feL.jpg',
      ],
      price: 34,
      description: '''
...
'''),
  Product(
      ...
      category: Category.baby,
      images: [
        'assets/cdn/41cdvZ8dqL.jpg',
        'assets/cdn/41Qfz77nF2L.jpg',
        'assets/cdn/41B7-wE7wdL.jpg',
        'assets/cdn/517UNfZBIdL.jpg'
      ],
      price: 60,
      description: '''
...
'''),
  Product(
      ...
      images: [
        'assets/cdn/01-26.jpg',
        'assets/cdn/02-26-600x600.jpg',
        'assets/cdn/03-26-600x600.jpg'
      ],
      price: 380,
...
We are motivated and enthusiastic to have a perfect record in customer satisfaction and providing products at a great price. All our items are 100% genuine and are of high quality diamonds, which have amazing clarity and color. Jewelry for Less is known for the variety of jewelry in both Men’s and Ladies fashion. We value every customer and we want to ensure the satisfaction of each customer. We will make the commitment to every single customer that they will have the best experience here at our store. At the end we treat each and every customer with the same level of courtesy and respect that we expect to receive. If you have any questions about the item feel free to contact us via eBay by clicking on the ask seller button.'''),
  Product(
      ...
      category: Category.gadgets,
      images: [
        'assets/cdn/51HsgZiV7wL._AC_.jpg',
        'assets/cdn/41VZDAiuFLL._AC_.jpg',
        'assets/cdn/41gDYljnCpL._AC_.jpg',
        'assets/cdn/41mDdfCVpHL._AC_.jpg',
      ],
      price: 50,
      description:
...
CORD AND ANTENNA FREE design lets you move easily on the job'''),
  Product(
      ...
      category: Category.gadgets,
      images: [
        'assets/cdn/01-24-600x600.jpg',
        'assets/cdn/02-24-600x600.jpg',
        'assets/cdn/03-24-600x600.jpg',
        'assets/cdn/04-24.jpg',
      ],
      price: 24,
      description: '''
...
'''),
  Product(
      ...
      category: Category.gadgets,
      images: [
        'assets/cdn/41ysi9t4l3L._AC_.jpg',
        'assets/cdn/51u7HR7K5aL._AC_.jpg',
        'assets/cdn/41bOjWomsdL._AC_.jpg',
      ],
      price: 32,
      description: '''
...
'''),
  Product(
      ...
      images: [
        'assets/cdn/51cl0SGfyOL._AC_.jpg',
        'assets/cdn/51ZTbyIHUcL._AC_.jpg',
        'assets/cdn/510tFas0yxL._AC_.jpg',
        'assets/cdn/51Gdtzd4XzL._AC_.jpg'
      ],
      price: 27,
      description:
...
Easy to install and waterproof. No wire required and simple to use'''),
  Product(
      ...
      category: Category.garden,
      images: [
        'assets/cdn/51p6PtUAxnL._AC_.jpg',
        'assets/cdn/51QOQd9abmL._AC_.jpg',
        'assets/cdn/41kshDSirWL._AC_.jpg',
        'assets/cdn/61Pn54vhnqL._AC_.jpg',
      ],
      price: 14,
      description: '''
...
'''),
  Product(
      ...
      category: Category.garden,
      images: [
        'assets/cdn/41YtT9ZdBL._AC_.jpg',
        'assets/cdn/410DjirTKiL._AC_.jpg',
        'assets/cdn/51qXUNbDmyL._AC_.jpg',
        'assets/cdn/61okTC5UcKL._AC_.jpg'
      ],
      price: 5,
      description: '''
...
'''),
  Product(
      ...
      category: Category.garden,
      images: [
        'assets/cdn/61oqgfHY4ZL._AC_.jpg',
        'assets/cdn/51qvfcUCD1L._AC_.jpg',
        'assets/cdn/51vmzQmmitL._AC_-100x100.jpg',
        'assets/cdn/51X14eFJZL._AC_.jpg',
        'assets/cdn/51PJtWtSb1L._AC_.jpg',
      ],
      price: 30,
...
Package include: 2 x Solar Lanterns'''),
  Product(
      ...
      category: Category.garden,
      images: [
        'assets/cdn/51szLpCVXfL._AC_.jpg',
        'assets/cdn/51Rvj8X29vL._AC_.jpg',
        'assets/cdn/51pXDVDQ7L._AC_.jpg',
        'assets/cdn/51VS3XwEg6L._AC_.jpg'
      ],
      price: 34,
...
Soft fabric/Plastic&Aluminum/ABS-Stainless Steel Stem'''),
  Product(
      ...
      images: [
        'assets/cdn/41FU83XCQYL._AC_.jpg',
        'assets/cdn/51406uKJ1L._AC_.jpg',
        'assets/cdn/51K9Qrz5NUL._AC_.jpg'
      ],
      price: 42,
      description:
...
Natural tension and stress relief, relaxation'''),
  Product(
      ...
      category: Category.health,
      images: [
        'assets/cdn/51j8imE7NzL._AC_.jpg',
        'assets/cdn/41x1UrLd-kL._AC_.jpg',
        'assets/cdn/51Jg4a9QA1L._AC_.jpg',
        'assets/cdn/513-Lbwx2NL._AC_.jpg',
        'assets/cdn/514O9MUELTL._AC_.jpg',
      ],
      price: 32,
      description: '''
...
'''),
  Product(
      ...
      category: Category.health,
      images: [
        'assets/cdn/51d88jyhsjL._AC_.jpg',
        'assets/cdn/51MGhJXPKTL._AC_.jpg',
        'assets/cdn/51hDJ4QnwL._AC_.jpg',
        'assets/cdn/51HFnSHEvDL._AC_.jpg',
        'assets/cdn/51fAeyuDyFL._AC_.jpg',
        'assets/cdn/51FqNHQvrlL._AC_.jpg',
        'assets/cdn/512ZEjAcIdL._AC_.jpg',
      ],
      price: 28,
      description: '''
...
'''),
  Product(
      ...
      images: [
        'assets/cdn/414fGr1F0L._AC_.jpg',
        'assets/cdn/31WPDLu1j2L._AC_.jpg',
        'assets/cdn/31FC-RsVx0L._AC_.jpg',
        'assets/cdn/51JOppp55KL._AC_.jpg',
        'assets/cdn/61gnN5PZtbL._AC_.jpg',
        'assets/cdn/51F7Q2WoRpL._AC_.jpg',
      ],
      price: 48,
      description: '''
...
'''),
  Product(
      ...
      category: Category.home,
      images: [
        'assets/cdn/01-34.jpg',
        'assets/cdn/02-36.jpg',
        'assets/cdn/03-36.jpg',
        'assets/cdn/04-35.jpg',
        'assets/cdn/05-34.jpg',
        'assets/cdn/06-32.jpg',
      ],
      price: 2,
      description: '''
...
Packing: 1pcs/pack'''),
  Product(
      ...
      category: Category.home,
      images: [
        'assets/cdn/51iC0wj8aAL._AC_.jpg',
        'assets/cdn/41KkNFY618L._AC_.jpg',
        'assets/cdn/41KN2218reL._AC_.jpg',
      ],
      price: 14,
      description: '''
...
'''),
  Product(
      ...
      category: Category.home,
      images: [
        'assets/cdn/21lw3FWfaL._AC_.jpg',
        'assets/cdn/41HWS5qa7xL._AC_.jpg',
        'assets/cdn/41JgMlBKhiL._AC_.jpg',
        'assets/cdn/41tGeUmzYeL._AC_.jpg',
      ],
      price: 13,
      description: '''
...
'''),
  Product(
      ...
      images: [
        'assets/cdn/01-15.jpg',
        'assets/cdn/02-14-600x600.jpg',
        'assets/cdn/03-14-600x600.jpg',
        'assets/cdn/04-14-600x600.jpg',
      ],
      price: 8,
      description:
...
3.Due to the difference between different monitors, the picture may not reflect the actual color of the item. Thank you!'''),
  Product(
      ...
      category: Category.pet,
      images: [
        'assets/cdn/Fresh-Step1-600x643.jpg',
        'assets/cdn/Fresh-Step-Extreme-Scented-Litter2-1-600x600.jpg',
        'assets/cdn/Fresh-Step-Extreme-Scented-Litter3-1-600x600.jpg',
        'assets/cdn/Fresh-Step-Extreme-Scented-Litter4-1.jpg',
        'assets/cdn/Fresh-Step-Extreme-Scented-Litter5-1-600x600.jpg',
        'assets/cdn/Fresh-Step-Extreme-Scented-Litter6-1-600x600.jpg',
      ],
      price: 9,
      description:
...
FRESH STEP LIGHTWEIGHT CAT LITTER: This unscented Fresh Step cat scoopable litter is created with your cat’s health and happiness in mind in a lightweight formula that’s easier to lift, pour, and store'''),
  Product(
      ...
      category: Category.pet,
      images: [
        'assets/cdn/Hartz-Just-For-Cats1-600x1058.jpg',
        'assets/cdn/Hartz-Just-For-Cats2-600x1071.jpg',
        'assets/cdn/Hartz-Just-For-Cats3.jpg',
        'assets/cdn/Hartz-Just-For-Cats4-600x600.jpg',
      ],
      price: 3,
      description:
...
Exercise your cat’s natural instincts to explore and thrive in the world around them with toys that stimulate all of their natural play needs'''),
  Product(
      ...
      category: Category.pet,
      images: [
        'assets/cdn/IAMS-7.jpg',
        'assets/cdn/IAMS-8.jpg',
        'assets/cdn/IAMS-9-600x600.jpg',
        'assets/cdn/IAMS-10.jpg',
      ],
      price: 37,
      description: '''
...
'''),
  Product(
      ...
      category: Category.pet,
      images: [
        'assets/cdn/Litter-Genie1.jpg',
        'assets/cdn/Litter-Genie2-600x600.jpg',
        'assets/cdn/Litter-Genie3-600x600.jpg',
        'assets/cdn/Litter-Genie4-600x600.jpg',
      ],
      price: 27,
      description: '''
...
'''),
  Product(
      ...
      images: [
        'assets/cdn/41gRHZ9my5L._AC_.jpg',
        'assets/cdn/413eToOp4JL._AC_.jpg',
        'assets/cdn/41t2i5lToAL._AC_.jpg',
        'assets/cdn/21DSte8H0iL._AC_.jpg',
        'assets/cdn/31rlIiInnxL._AC_.jpg',
      ],
      price: 44,
      description: '''
...
'''),
  Product(
      ...
      category: Category.sports,
      images: [
        'assets/cdn/31ZSv3wfcaL._AC_.jpg',
        'assets/cdn/312geIeOm9L._AC_.jpg',
        'assets/cdn/31QoryW1jdL._AC_.jpg',
        'assets/cdn/31FgiqP-7BL._AC_.jpg',
      ],
      price: 11,
      description: '''
...
'''),
  Product(
      ...
      category: Category.sports,
      images: [
        'assets/cdn/51lDHMwnNL._AC_.jpg',
        'assets/cdn/41jhhqtVcOL._AC_.jpg',
        'assets/cdn/51wZOnvTL._AC_.jpg',
        'assets/cdn/51wOep5ikFL._AC_.jpg',
        'assets/cdn/51nFeqXup0L._AC_.jpg',
        'assets/cdn/51KjP6Gfd5L._AC_.jpg',
        'assets/cdn/51OYKSV5c3L._AC_.jpg',
        'assets/cdn/41sMNvyqJ9L._AC_.jpg',
      ],
      price: 13,
      description: '''
...
FITTIN SPORT invite you to enjoy the sleek and soft feel of this women’s comfort flex fit get cozy racer back bra.Built for Low-Med Impact activity & all-day comfort.Offering a clasp-free design, this pullover bra features wide shoulder straps and a racer back for a supportive fit. A wide center gore, stretch band and wireless design provide a smooth and flattering look. Deep plunge detail with skinny racer back for enhanced mobility. Wear this bra with confidence all day.'''),
  Product(
      ...
      category: Category.sports,
      images: [
        'assets/cdn/41og36QX6CL._AC_.jpg',
        'assets/cdn/1595797729_51bFo4E70XL._AC_.jpg',
        'assets/cdn/1595797742_51lFIZZDptL._AC_.jpg',
        'assets/cdn/1595797757_41GrNfUW3uL._AC_.jpg',
        'assets/cdn/1595797799_51xRe01TzYL._AC_.jpg',
      ],
      price: 26,
...
Charging time: 8 hours'''),
  Product(
      ...
      category: Category.sports,
      images: [
        'assets/cdn/41kqLw-M0ZL._AC_.jpg',
        'assets/cdn/51Pg-CW-aIL._AC_.jpg',
        'assets/cdn/51Vm3BPHV0L._AC_.jpg',
        'assets/cdn/41xeSnBIozL._AC_.jpg',
        'assets/cdn/41eg8ALV6XL._AC_.jpg',
        'assets/cdn/4122CypSINL._AC_.jpg',
        'assets/cdn/51Tnl4uda5L._AC_.jpg',
      ],
      price: 15,
      description:
...
Support: Open Racer Back to Keep You Cool And Supported. Compression Fit.'''),
  Product(
      ...
      images: [
        'assets/cdn/51Uol3pwbL._AC_.jpg',
        'assets/cdn/41BNjjt87oL._AC_.jpg',
        'assets/cdn/51MczHtzpNL._AC_.jpg',
        'assets/cdn/41ZcGAyjP-L._AC_.jpg',
        'assets/cdn/41d1gPRZQ2L._AC_.jpg',
        'assets/cdn/41yRaIau7ML._AC_.jpg',
        'assets/cdn/21zShewf9aL._AC_.jpg',
      ],
      price: 30,
...
'''),
  Product(
      ...
      category: Category.tools,
      images: [
        'assets/cdn/41wm2kh2I5L._AC_.jpg',
        'assets/cdn/31ucUK49L._AC_.jpg',
        'assets/cdn/31sm-jbbjJL._AC_.jpg',
        'assets/cdn/312jO3K-4YL._AC_.jpg',
        'assets/cdn/51XCJP1HMLL._AC_.jpg',
        'assets/cdn/41hnNIvA2sL._AC_.jpg',
      ],
      price: 20,
      description: '''
...
'''),
  Product(
      ...
      category: Category.tools,
      images: [
        'assets/cdn/518wI0W2BsL._AC_.jpg',
        'assets/cdn/41ujSbsvIDL._AC_.jpg',
        'assets/cdn/419ztW-2FvL._AC_.jpg',
      ],
      price: 72,
      description: '''
...
'''),
  Product(
      ...
      images: [
        'assets/cdn/01-8.jpg',
        'assets/cdn/02-7-600x600.jpg',
        'assets/cdn/03-7-600x600.jpg',
        'assets/cdn/03-7-600x600.jpg',
        'assets/cdn/04-7.jpg',
        'assets/cdn/05-6-600x600.jpg',
        'assets/cdn/06-6.jpg',
      ],
      price: 2,
...
Package Include: 1 x Cabinet Lock'''),
  Product(
      ...
      category: Category.tools,
      images: [
        'assets/cdn/41zK8gL-n1L._AC_.jpg',
        'assets/cdn/41pqcdph9tL._AC_.jpg',
        'assets/cdn/41pMD3upGL._AC_.jpg',
        'assets/cdn/510bbL11lEL._AC_.jpg',
        'assets/cdn/413EOkuKtiL._AC_.jpg',
        'assets/cdn/51q9go5IL._AC_.jpg',
      ],
      price: 23,
      description:
...
INCLUDES- Extra 0. 3 in. (8mm) stainless steel pins, protective cap that doubles as a calibration checker and a “9V” battery'''),
  Product(
      ...
      images: [
        'assets/cdn/1.1.543015c863.999xx_ctngsmenkhxqxmyh_dwc0fowgci90crfo.jpg',
        'assets/cdn/1.1.543015c863.999xx_ctngsmenkhxqxmyh_dwc0fowgci90crfo.jpg',
        'assets/cdn/1.1.543015c863.999xx_ctngsmenkhxqxmyh_dwc0fowgci90crfo.jpg',
      ],
      price: 155,
...
AirPods have a battery life of more than 24 hours when used with the MagSafe Charging Case. Wireless chargers, including MagSafe, are compatible with the charging case, making wireless charging a breeze with quick attachment for increased convenience.'''),
  Product(
      ...
      category: Category.electronics,
      images: [
        'assets/cdn/soim.27.1.74a6e6f44b.999xx_yhajdnagxcu2avqj.jpg',
        'assets/cdn/soim.27.2.1ce91a59ca.999xx_qn3nemgwqrwgtqqv.jpg',
        'assets/cdn/soim.27.3.5d2ffec47a.999xx_7rfyqiv8vv6mnx1e.jpg',
      ],
      price: 66,
      description:
...
-Comes with headphones.'''),
  Product(
      ...
      category: Category.electronics,
      images: [
        'assets/cdn/a80kexample.13a0f93047.999xx_nadeyalyu7z56hsj.jpg',
        'assets/cdn/444.1.77d640abcf.999xx_kmk0tiplabubqnvi.jpg',
        'assets/cdn/444.3.67dddfe4d6.999xx_pfzzous7lwswffg3.jpg',
        'assets/cdn/444.4.23e858e693.999xx_n3ezrl9q9qgb7lj5.jpg',
      ],
      price: 1650,
...
Perfect for PlayStation®5 - Pair your BRAVIA XR TV with a PlayStation®5 console to get a Sony-exclusive fantastic gaming experience. With immersive picture and sound, you'll feel like you're right in the middle of the action.'''),
  Product(
      ...
      category: Category.electronics,
      images: [
        'assets/cdn/17.1.jpg.8966356bd5.999xx_exmpcngxuepv2bnb_tlzgx9fi4rpxfl8s.png',
        'assets/cdn/17.1.jpg.8966356bd5.999xx_exmpcngxuepv2bnb_tlzgx9fi4rpxfl8s.png',
      ],
      price: 300,
      description: '''
...
SMOKE SETTING'''),
  Product(
      ...
      category: Category.electronics,
      images: [
        'assets/cdn/mcsa01869111hkk99v850mrangecookerboschstpdef.7b736d40bd.999xx_z9tvt0rsvcrfwuff.jpg',
        'assets/cdn/mcsa01869100hkk99v850mrangecookerboschpga2def.a0f38cb09e.999xx_be1sal8zljbsaatv.jpg',
        'assets/cdn/mcsa01869103hkk99v850mrangecookerboschpga1def.78dd98f681.999xx_h2nlkhrv0fuegcyl.jpg',
        'assets/cdn/mcsa01869107hkk99v850mrangecookerboschpga4def.b86e394437.999xx_sz7ckmg4sulfaqdu.jpg',
        'assets/cdn/mcsa01869108hkk99v850mrangecookerboschpga3def.c3a3b1f857.999xx_6vm8j8rbxqffewxh.jpg'
      ],
      price: 999,
...
Splash guard'''),
  Product(
      ...
      category: Category.electronics,
      images: [
        'assets/cdn/wwg660twf6401.0aa3cc22f4.999xx_wydtfrjfgwr7wksd.jpg',
        'assets/cdn/wwg660twf6401.0aa3cc22f4.999xx_wydtfrjfgwr7wksd.jpg',
      ],
      price: 1249,
      description:
